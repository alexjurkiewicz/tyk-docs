...
#### Tyk Gateway version
Set version of gateway at `tyk-gateway.gateway.image.tag`. You could find the list of version tags available from [Docker hub](https://hub.docker.com/u/tykio). Please check [Tyk Release notes]({{<ref "/release-notes">}}) carefully while upgrading or downgrading.
...
Default service port of gateway is 8080. You can it at `global.servicePorts.gateway`.
